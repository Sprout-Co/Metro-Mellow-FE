  ...
  return (
    <section className={styles.cta}>
      <div className={styles.cta__container}>
        ...
        >
          <h2 className={styles.cta__title}>Ready to Experience the Metro Mellow Difference?</h2>
          <p className={styles.cta__description}>
            Join thousands of satisfied customers who have transformed their home life with our 
            comprehensive service solutions. Get started today!
          </p>
        ...
        >
          <div className={styles.cta__feature}>
            ...
            <div className={styles.cta__featureText}>
              <h4 className={styles.cta__featureTitle}>Satisfaction Guaranteed</h4>
              <p className={styles.cta__featureDescription}>100% satisfaction or we'll make it right</p>
            </div>
          </div>
          ...
          <div className={styles.cta__feature}>
            ...
            <div className={styles.cta__featureText}>
              ...
              <p className={styles.cta__featureDescription}>All services backed by comprehensive insurance</p>
            </div>
          </div>
          ...
          <div className={styles.cta__feature}>
            ...
            <div className={styles.cta__featureText}>
              ...
              <p className={styles.cta__featureDescription}>Book services when it's convenient for you</p>
            </div>
          </div>
          ...
          <div className={styles.cta__feature}>
            ...
            <div className={styles.cta__featureText}>
              ...
              <p className={styles.cta__featureDescription}>Background-checked, experienced staff</p>
            </div>
          </div>
        </motion.div>
      </div>
