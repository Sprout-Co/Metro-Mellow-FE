...
const steps = [
  {
    ...
    description:
      "Choose from our range of home services and select a date and time that works for you.",
  ...
  },
  {
    ...
    title: "Get Matched",
    description:
      "We will match you with experienced, background-checked professionals in your area.",
  ...
  },
  {
    ...
    description:
      "Our professionals arrive on time and complete the service to your satisfaction.",
  ...
  },
  {
    ...
    title: "Rate & Review",
    description:
      "Share your feedback and book recurring services for additional convenience.",
      ...
      <div className={styles.process__container}>
        ...
        >
          ...
          <p className={styles.process__subtitle}>
            Getting started with Metromellow is simple and straightforward
          </p>
        </motion.div>
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className={styles.process__stepContent}>
                ...
                <p className={styles.process__stepDescription}>
                  {step.description}
                </p>
              </div>
            </motion.div>
