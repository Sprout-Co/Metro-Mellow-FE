...
const testimonials = [
  {
    ...
    quote: 'Metro Mellow has transformed my weekly cleaning routine. Their team is professional, thorough, and always goes above and beyond. Highly recommend!',
  ...
  },
  {
    ...
    location: 'Chicago, IL',
    quote: 'I\'ve been using their meal preparation service for 3 months now, and it has saved me so much time. The food is always delicious and customized to my preferences.',
  ...
  },
  {
    ...
    quote: 'The laundry service is exceptional! They handle everything with care and my clothes come back perfectly folded. It\'s one less thing I have to worry about.',
  ...
  },
  {
    ...
    name: 'David Williams',
    location: 'Austin, TX',
    quote: 'Their pest control service was quick, effective, and used eco-friendly products which was important to me. Haven\'t seen a single pest since!',
            ...
            >
              ...
              <div className={styles.testimonials__author}>
                ...
                <div className={styles.testimonials__info}>
                  ...
                  <p className={styles.testimonials__location}>{testimonial.location}</p>
                  <div className={styles.testimonials__service}>{testimonial.service}</div>
