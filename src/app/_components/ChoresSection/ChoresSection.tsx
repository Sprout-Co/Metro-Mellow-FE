...
const services = [
  {
    ...
    icon: '/images/icons/errand-icon.svg', // 3D isometric star icon
  ...
  },
  {
    ...
    icon: '/images/icons/food-icon.svg', // 3D isometric cookie icon
    bg: 'chores-card--food',
    btn: 'chores-card__btn--primary',
  },
  {
    name: 'Pest Control',
    desc: 'Enjoy your work without the pressure of wondering what would happen to you if you lose.',
    icon: '/images/icons/pest-icon.svg', // 3D isometric clock icon
    bg: 'chores-card--pest',
    btn: 'chores-card__btn--primary',
  },
  {
    name: 'Cleaning',
    desc: 'Enjoy work without the pressure of wondering what would happen to you if you lose your job.',
    icon: '/images/icons/cleaning-icon.svg', // 3D isometric lightning bolt
  ...
  },
  {
    name: 'Laundry',
    desc: 'Enjoy work without the pressure of wondering what would happen to you if you lose your job.',
    icon: '/images/icons/laundry-icon.svg', // 3D isometric checkmark/basket icon
          ...
          {services.map((service) => (
            <div key={service.name} className={`${styles['chores-card']} ${styles[service.bg]}`}>
              <div className={styles['chores-card__icon']}>
                <img src={service.icon} alt={`${service.name} service icon`} />
              </div>
