...
export default function RegisterForm({ onSuccess, onLoginClick }: RegisterFormProps) {
  ...
  const passwordStrength = (): { strength: 'weak' | 'medium' | 'strong', percentage: number } => {
    if (!formData.password) {
    ...
    <div className={styles.registerForm}>
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <p className={styles.registerForm__subtitle}>Join Metro Mellow to get started</p>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            {formData.password && (
              <div className={styles.registerForm__passwordStrength}>
                ...
                <div className={styles.registerForm__passwordStrengthText}>
                  Password strength: <span className={styles[`registerForm__passwordStrengthLabel--${strength}`]}>{strength}</span>
                </div>
              </div>
            )}
            ...
            <div className={styles.registerForm__checkGroup}>
              ...
              {errors.agreeTerms && (
                <p className={styles.registerForm__checkError}>{errors.agreeTerms}</p>
              )}
            </div>
