      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          >
            {error && (
              <div
                className={`${styles.verificationForm__message} ${error.includes("has been sent") ? styles["verificationForm__message--success"] : styles["verificationForm__message--error"]}`}
              >
            ...
            <div className={styles.verificationForm__actions}>
              ...
              >
                {loading ? (
                  <>
                    <div
                      className={styles.verificationForm__buttonSpinner}
                    ></div>
                    Verifying...
                  </>
                ) : (
