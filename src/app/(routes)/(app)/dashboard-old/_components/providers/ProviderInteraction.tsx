...
const providers = [
  {
    ...
    bio: "Sarah has been with Metromellow for 3 years and specializes in deep cleaning and organization. She has a keen eye for detail and takes pride in leaving homes spotless.",
...
const feedback = [
  {
    ...
    rating: 5,
    comment:
      "Sarah did an amazing job! My home has never been cleaner. She paid attention to every detail and was very professional.",
    date: "2025-03-11",
    user: "John D.",
  },
  {
    ...
    rating: 4,
    comment:
      "Michael handled my laundry with care. All stains were removed and my clothes smell great. Very satisfied with the service.",
    date: "2025-03-12",
    user: "Emily S.",
  },
  {
    ...
    rating: 5,
    comment:
      "Consistently excellent service from Sarah. She is reliable, thorough, and always goes the extra mile.",
    date: "2025-03-04",
    user: "David W.",
  },
];
...
const messages = [
  {
    ...
    sender: "provider",
    content:
      "Hello! Just confirming our appointment for next Monday at 9 AM. Is there anything specific you would like me to focus on during the cleaning?",
  ...
  },
  {
    ...
    sender: "user",
    content:
      "Hi Sarah! Yes, Monday at 9 AM works great. If you could please pay extra attention to the kitchen and bathroom, that would be wonderful. Thank you!",
  ...
  },
  {
    ...
    sender: "provider",
    content:
      "Absolutely! I will make sure those areas receive special attention. See you on Monday!",
        ...
        {Array(fullStars)
          ...
          .map((_, i) => (
            <Icon
              key={`full-${i}`}
              name="star"
              className={styles.provider__starFull}
            />
          ))}
        {halfStar && (
          <Icon name="star-half" className={styles.provider__starHalf} />
        )}
        {Array(emptyStars)
          .fill(0)
          .map((_, i) => (
            <Icon
              key={`empty-${i}`}
              name="star"
              className={styles.provider__starEmpty}
            />
          ))}
      </div>
    );
              ...
              >
                ...
                <div className={styles.providers__info}>
                  ...
                  <div className={styles.providers__rating}>
                    <span className={styles.providers__ratingValue}>
                      {provider.rating}
                    </span>
                    <Icon
                      name="star"
                      className={styles.providers__ratingIcon}
                    />
          ...
          {selectedProvider ? (
                      ...
                      <div className={styles.providers__providerProfile}>
                        <div className={styles.providers__profileAvatar}>
                          {provider.avatar ? (
                            ...
                            <div
                              className={
                                styles.providers__profileAvatarPlaceholder
                              }
                            >
                              {provider.name
                                .split(" ")
                        ...
                        <div className={styles.providers__profileInfo}>
                          <h2 className={styles.providers__profileName}>
                            {provider.name}
                          </h2>
                          <p className={styles.providers__profileRole}>
                            {provider.role}
                          </p>
                          <div className={styles.providers__profileMeta}>
                            <div className={styles.providers__profileRating}>
                              ...
                              <span
                                className={styles.providers__profileRatingValue}
                              >
                                {provider.rating}
                              </span>
                              <span
                                className={styles.providers__profileRatingCount}
                              >
                            ...
                            <div className={styles.providers__profileServices}>
                              <span
                                className={
                                  styles.providers__profileServicesLabel
                                }
                              >
                                Services:
                              </span>
                              {provider.services.map((service, index) => (
                                <span
                                  key={index}
                                  className={styles.providers__profileService}
                                >
                                  {service}
                                </span>
                              ))}
                        ...
                        {activeTab === "profile" && (
                          ...
                          >
                            <div className={styles.providers__profileSection}>
                              ...
                              <p className={styles.providers__bio}>
                                {provider.bio}
                              </p>
                            </div>
                              ...
                              <div className={styles.providers__profileSection}>
                                ...
                                <div className={styles.providers__badges}>
                                  {provider.badges.map((badge, index) => (
                                    <span
                                      key={index}
                                      className={styles.providers__badge}
                                    >
                                      {badge}
                                    </span>
                                  ))}
                            ...
                            <div className={styles.providers__profileSection}>
                              ...
                              <div className={styles.providers__availability}>
                                <div
                                  className={styles.providers__availabilityItem}
                                >
                                  <span
                                    className={
                                      styles.providers__availabilityLabel
                                    }
                                  >
                                    Next Available:
                                  </span>
                                  <span
                                    className={
                                      styles.providers__availabilityValue
                                    }
                                  >
                                    {formatDate(
                            ...
                            <div className={styles.providers__profileSection}>
                              ...
                              <div className={styles.providers__reviews}>
                                {getProviderFeedback(provider.id)
                                  .slice(0, 2)
                                  .map((review) => (
                                    <div
                                      key={review.id}
                                      className={styles.providers__review}
                                    >
                                      <div
                                        className={
                                          styles.providers__reviewHeader
                                        }
                                      >
                                        <div
                                          className={
                                            styles.providers__reviewRating
                                          }
                                        >
                                      ...
                                      <p
                                        className={
                                          styles.providers__reviewComment
                                        }
                                      >
                                        {review.comment}
                                      </p>
                                      <div
                                        className={styles.providers__reviewUser}
                                      >
                                        {review.user}
                                      </div>
                                    </div>
                        ...
                        {activeTab === "messages" && (
                          ...
                          >
                            ...
                            <div className={styles.providers__messages}>
                              {getProviderMessages(provider.id).map(
                                (message) => (
                                  <div
                                    key={message.id}
                                    className={`${styles.providers__message} ${
                                      message.sender === "user"
                                        ? styles["providers__message--outgoing"]
                                        : ""
                                    }`}
                                  >
                                    {message.sender === "provider" && (
                                      <div
                                        className={
                                          styles.providers__messageAvatar
                                        }
                                      >
                                        {provider.avatar ? (
                                          <Image
                                            ...
                                            height={36}
                                            className={
                                              styles.providers__messageAvatarImg
                                            }
                                          />
                                        ) : (
                                          <div
                                            className={
                                              styles.providers__messageAvatarPlaceholder
                                            }
                                          >
                                            {provider.name
                                              .split(" ")
                                    ...
                                    <div
                                      className={
                                        styles.providers__messageContent
                                      }
                                    >
                                      <div
                                        className={
                                          styles.providers__messageBubble
                                        }
                                      >
                                        {message.content}
                                      </div>
                        ...
                        {activeTab === "feedback" && (
                          ...
                          >
                            <div className={styles.providers__feedbackHeader}>
                              ...
                              <div className={styles.providers__overallRating}>
                                ...
                                <div className={styles.providers__ratingStars}>
                                  {getStars(provider.rating)}
                                  <span
                                    className={styles.providers__ratingTotal}
                                  >
                                    ({provider.reviewsCount} reviews)
                                  </span>
                                </div>
                            ...
                            <div className={styles.providers__reviewsList}>
                              {getProviderFeedback(provider.id).map(
                                (review) => (
                                  <div
                                    key={review.id}
                                    className={styles.providers__reviewFull}
                                  >
                                    <div
                                      className={styles.providers__reviewHeader}
                                    >
                                      <div>
                                        <div
                                          className={
                                            styles.providers__reviewUser
                                          }
                                        >
                                          {review.user}
                                        </div>
                            ...
                            <div className={styles.providers__leaveFeedback}>
                              ...
                              <div className={styles.providers__feedbackForm}>
                                <div
                                  className={styles.providers__ratingSelector}
                                >
                                  <span
                                    className={styles.providers__ratingLabel}
                                  >
                                    Rate your experience:
                                  </span>
                                  <div
                                    className={styles.providers__ratingStars}
                                  >
                                    {[1, 2, 3, 4, 5].map((star) => (
                                      <button
                                        key={star}
                                ...
                                ></textarea>
                                <button
                                  className={styles.providers__submitFeedback}
                                >
                                  Submit Feedback
                                </button>
                              </div>
            ...
            <div className={styles.providers__empty}>
              ...
              <p className={styles.providers__emptyText}>
                Choose a service provider from the list to view their profile,
                send messages, or leave feedback.
              </p>
            </div>
          )}
        </div>
