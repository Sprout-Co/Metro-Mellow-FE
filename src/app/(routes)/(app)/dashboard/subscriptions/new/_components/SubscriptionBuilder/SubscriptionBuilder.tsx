...
const SubscriptionBuilder: React.FC = () => {
  ...
  const handleServiceConfigSave = (configuration: SubscriptionServiceInput) => {
    ...
    if (editingServiceId) {
      ...
      // For new configurations, always treat this as a single-service subscription
      // by replacing any existing configured services with the newly configured one.
          ...
          >
            <div className={styles.builder__sectionHeader}>
              ...
              <div>
                  ...
                  <p>You are creating a subscription for one service</p>
              </div>
            </div>
            <ServiceSelector
              services={services}
