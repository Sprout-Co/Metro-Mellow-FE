...
const ServiceSelector: React.FC<ServiceSelectorProps> = ({
  ...
  const getSelectedServiceId = () => {
    if (!configuredServices.length) return null;
    return configuredServices[0]?.service?._id ?? null;
  };
  ...
  return (
    <div className={styles.selector}>
      <div className={styles.selector__grid}>
        {services
          .filter((service) => service.category !== ServiceCategory.PestControl)
          .map((service, index) => {
            ...
            const hasAnyServiceSelected = !!selectedServiceId;
                ...
                <div className={styles.selector__content}>
                  ...
                  <div className={styles.selector__priceRow}>
                    ...
                    <span className={styles.selector__price}>
                      ...
                      <span className={styles.selector__priceUnit}>
                        /service
                      </span>
                    </span>
                  </div>
                      ...
                      >
                        <div className={styles.selector__configRow}>
                          ...
                          <span>
                            ...
                            •{" "}
                            {configuredData.configuration.scheduledDays
                              ?.length || 0}{" "}
                            days
                          </span>
                        </div>
                ...
                <div className={styles.selector__footer}>
                  {!configured ? (
                    disabled ? (
                      ...
                      <div className={styles.selector__disabledState}>
                        <span>Single-service subscription</span>
                        <small>
                          Remove the current service to choose a different one.
                        </small>
                      </div>
      ...
      {/* {configuredServices.length === 0 && (
        ...
        >
          <Sparkles size={24} />
          <p>Select a service above to create your subscription plan</p>
        </motion.div>
      )} */}
    </div>
  );
