...
import styles from "./MetroEatsFooter.module.scss";

export default function MetroEatsFooter() {
  return (
    <footer className={styles.footer}>
      <div className={styles.footer__inner}>
        <div className={styles.footer__brand}>
          <Link href="/metroeats" className={styles.footer__logo}>
            <Image
        ...
        <div className={styles.footer__columns}>
          <div className={styles.footer__col}>
            ...
            <Link href="/metroeats/menu?tab=buckets">Buckets</Link>
          ...
          <div className={styles.footer__col}>
            ...
            <Link href="/">MetroMellow</Link>
          </div>
          <div className={styles.footer__col}>
            <h4 className={styles.footer__colTitle}>Legal</h4>
      ...
      <div className={styles.footer__copy}>
        <p>© {new Date().getFullYear()} MetroEats. All rights reserved.</p>
      </div>
    </footer>
  );
}
