...
import styles from './LaundryContact.module.scss';
            ...
            <div className={styles.contact__container}>
                ...
                >
                    ...
                    <p className={styles.contact__description}>
                        Have questions about our services or need a custom quote? Fill out the form below and our team will get back to you promptly.
                    </p>
                </motion.div>
                            ...
                            <div className={styles.contact__details}>
                                <div className={styles.contact__detail}>
                                    ...
                                    <div className={styles['contact__detail-content']}>
                                        ...
                                        <p className={styles['contact__detail-text']}>123 Laundry Avenue, Suite 456<br />New York, NY 10001</p>
                                    </div>
                                </div>
                                ...
                                <div className={styles.contact__detail}>
                                    ...
                                    <div className={styles['contact__detail-content']}>
                                        ...
                                        <p className={styles['contact__detail-text']}>(555) 123-4567</p>
                                    </div>
                                </div>
                                ...
                                <div className={styles.contact__detail}>
                                    ...
                                    <div className={styles['contact__detail-content']}>
                                        ...
                                        <p className={styles['contact__detail-text']}>info@laundryservice.com</p>
                                    </div>
                                </div>
                        ...
                        {formStatus.submitted && formStatus.success ? (
                            ...
                            <form className={styles.contact__form} onSubmit={handleSubmit}>
                                <div className={styles.contact__fields}>
                                    ...
                                    <div className={styles.contact__field}>
                                        <label htmlFor="service" className={styles.contact__label}>Service Interested In</label>
                                        <select
                                            id="service"
                                            name="service"
                                    ...
                                    <div className={styles.contact__field}>
                                        ...
                                        <textarea
                                            ...
                                            placeholder="Tell us more about your laundry needs"
                                            rows={4}
                                            required
                                        ></textarea>
                                    </div>
