        ...
        <div className={styles.features__content}>
          ...
          >
            ...
            <motion.p 
              ...
              variants={fadeIn}
            >
              Fast, reliable, and eco-friendly. We keep it cool while keeping your wardrobe cooler.
            </motion.p>
            <motion.div 
              className={styles.features__cta}
              variants={fadeIn}
            >
              <Button href={Routes.GET_STARTED} className={styles.features__button}>
                START CLEANING
              </Button>
            </motion.div>
          </motion.div>
        ...
        <div className={styles.features__cards}>
          ...
          >
            ...
            <p className={styles.features__cardTextLarge}>
              Whether it's a quick rinse or a deep soak, our care hits every note perfectly.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className={styles.features__cardTextLarge}>
              Your clothes will feel like they just stepped off the runway. It's every note perfectly.
            </p>
          </motion.div>
        </div>
      </div>
