  ...
  const problems = [
    {
      ...
      title: "Time Poverty",
      description:
        "Nigerians spend 6+ hours weekly on household chores, missing out on family time and personal growth opportunities.",
      stat: "6+ hours weekly",
    },
    {
      icon: Zap,
      ...
      description:
        "Finding trustworthy professionals for home services is a major challenge, with 70% experiencing service issues.",
      stat: "70% face issues",
    },
    {
      icon: Users,
      ...
      description:
        "Rising dual-income households struggle to maintain homes while building careers and nurturing relationships.",
      stat: "85% struggle",
    },
    {
      icon: TrendingUp,
      ...
      description:
        "Fast-paced city life leaves little time for essential household tasks, increasing stress and decreasing quality of life.",
      ...
      <div className={styles.problemStatement__container}>
        ...
        >
          <h2 className={styles.problemStatement__title}>
            <span className={styles["problemStatement__title--accent"]}>
              The Reality
            </span>
          ...
          <p className={styles.problemStatement__subtitle}>
            Modern life demands more than we can give. Between work, family, and
            personal goals, household management becomes overwhelming. You're
        ...
        >
          ...
          <p className={styles.problemStatement__ctaText}>
            Imagine having reliable, professional home services at your
            fingertips. No more searching, no more disappointments, no more
            stress.
          </p>
        </motion.div>
      </div>
