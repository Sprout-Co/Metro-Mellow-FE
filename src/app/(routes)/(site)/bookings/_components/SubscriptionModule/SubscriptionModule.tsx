...
const SubscriptionModule: React.FC = () => {
  ...
  const [services, setServices] = useState<ServiceType[]>([
    { id: 'cleaning', name: 'Cleaning', icon: '🧹', minPrice: 7500, selected: true },
    { id: 'laundry', name: 'Laundry', icon: '👕', minPrice: 5000, selected: false },
    { id: 'cooking', name: 'Cooking', icon: '🍳', minPrice: 10000, selected: false },
  ]);
  ...
  return (
    <div className={styles.subscription}>
      <div className={styles.subscription__header}>
        ...
        <p className={styles.subscription__subtitle}>Customize your home service subscription in one place</p>
      </div>
