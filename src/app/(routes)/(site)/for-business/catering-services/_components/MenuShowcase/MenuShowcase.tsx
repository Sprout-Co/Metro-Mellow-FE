...
const menuCategories: MenuCategory[] = [
  {
    ...
    icon: <Coffee />,
    description:
      "Start your team's day right with fresh, energizing breakfast options",
    items: [
      {
    ...
    <section className={styles.menuShowcase}>
      <div className={styles.menuShowcase__container}>
        ...
        >
          ...
          <p>
            From energizing breakfasts to elegant dinners, we offer
            comprehensive catering solutions for every business occasion
          </p>
        </motion.div>
        ...
        >
          {menuCategories.map((category) => (
            ...
            >
              <div className={styles.tab__icon}>{category.icon}</div>
        ...
        >
          ...
          <p>
            Don't see what you're looking for? Our chefs can create custom menus
            tailored to your specific needs, dietary restrictions, and budget
            requirements.
          </p>
        </motion.div>
      </div>
