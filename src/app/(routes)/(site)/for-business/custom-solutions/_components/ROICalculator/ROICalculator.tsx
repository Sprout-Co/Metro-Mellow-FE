...
const ROICalculator: React.FC = () => {
  ...
  useEffect(() => {
    const monthlyInternalCost = inputs.employees * inputs.hourlyWage * inputs.cleaningHours;
    ...
    const paybackPeriod = inputs.monthlyServiceCost / Math.max(monthlySavings, 1);
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Professional services often cost less than internal resources"
    },
    {
      icon: <TrendingUp />,
      title: "Scalability",
    ...
    <section className={styles.roiCalculator}>
      <div className={styles.roiCalculator__container}>
        ...
        >
          ...
          <p>See how much you could save by outsourcing your facility management to Metro Mellow</p>
        </motion.div>
        ...
        <div className={styles.roiCalculator__content}>
          ...
          >
            ...
            <div className={styles.input__group}>
              ...
              <input
                ...
                onChange={(e) => handleInputChange('cleaningHours', parseInt(e.target.value) || 0)}
                min="0"
              />
            </div>
            ...
            <div className={styles.input__group}>
              ...
              <input
                ...
                onChange={(e) => handleInputChange('monthlyServiceCost', parseFloat(e.target.value) || 0)}
                min="0"
                step="50"
              />
            </div>
          ...
          >
            ...
            <div className={styles.payback__period}>
              <strong>Payback Period: {results.paybackPeriod.toFixed(1)} months</strong>
            </div>
