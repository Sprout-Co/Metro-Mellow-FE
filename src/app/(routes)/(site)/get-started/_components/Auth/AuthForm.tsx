  ...
  const handleVerificationChange = (index: number, value: string) => {
    if (value.length > 1) {
      ...
      if (pasteData.length >= 6) {
        ...
        console.log('Verification code submitted:', newVerificationCode.join(''));
      }
    } else {
            ...
            <AnimatePresence mode="wait">
              {authMode === 'login' && (
                ...
                >
                  ...
                  <p className={styles.auth__subtitle}>Sign in to continue to Metro Mellow</p>
                  ...
                  <form onSubmit={handleLoginSubmit}>
                    <div className={styles.auth__inputGroup}>
                      <label className={styles.auth__label}>Email Address</label>
                      <div className={styles.auth__inputWrapper}>
                        <input 
                          ...
                          required
                        />
                        <svg className={styles.auth__inputIcon} width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className={styles.auth__inputGroup}>
                      <div className={styles.auth__labelFlex}>
                        ...
                        <Link href="/forgot-password" className={styles.auth__labelLink}>
                          Forgot Password?
                        </Link>
                      </div>
                      <div className={styles.auth__inputWrapper}>
              ...
              {authMode === 'register' && (
                ...
                >
                  ...
                  <p className={styles.auth__subtitle}>Join Metro Mellow to get started</p>
                  ...
                  <form onSubmit={handleRegisterSubmit}>
                    <div className={styles.auth__inputGroup}>
                      <label className={styles.auth__label}>Full Name</label>
                      <div className={styles.auth__inputWrapper}>
                        <input 
                          type="text" 
                          className={styles.auth__input}
                    ...
                    <div className={styles.auth__inputGroup}>
                      <label className={styles.auth__label}>Confirm Password</label>
                      <div className={styles.auth__inputWrapper}>
                        <input 
                          type="password" 
                          className={styles.auth__input}
              ...
              {authMode === 'verify' && (
                ...
                >
                  ...
                  <form onSubmit={handleVerificationSubmit}>
                    <div className={styles.auth__verificationCode}>
                      {verificationCode.map((digit, index) => (
                        <input
                          ...
                          onFocus={() => setActiveVerificationIndex(index)}
                  ...
                  <div className={styles.auth__resend}>
                    ...
                    <button 
                      type="button" 
                      className={styles.auth__resendLink}
            ...
            <div className={styles.auth__image}>
              ...
              <div className={styles.auth__stats}>
                ...
                <div className={styles.auth__statItem}>
                  ...
                  <div className={styles.auth__statLabel}>Services Completed</div>
                </div>
                <div className={styles.auth__statItem}>
