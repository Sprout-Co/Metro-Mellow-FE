    ...
    <div className={styles.loginForm}>
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <p className={styles.loginForm__subtitle}>Sign in to continue to Metro Mellow</p>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className={styles.loginForm__passwordGroup}>
              <div className={styles.loginForm__passwordHeader}>
                <label htmlFor="login-password" className={styles.loginForm__label}>
                  Password<span className={styles.loginForm__required}>*</span>
                </label>
                <Link href="/forgot-password" className={styles.loginForm__forgotPassword}>
                  Forgot Password?
                </Link>
              </div>
