      ...
      <div className={styles.loginModal}>
        ...
        <div className={styles.loginModal__formContainer}>
          ...
          <div className={styles.loginModal__header}>
            <h2 className={styles.loginModal__title}>
              Sign in with your work email
            </h2>
            <p className={styles.loginModal__subtitle}>
          ...
          <form className={styles.loginModal__form} onSubmit={handleLogin}>
            <div className={styles.loginModal__formGroup}>
              <label htmlFor="email" className={styles.loginModal__label}>
                Email Address
              </label>
              <input
                type="email"
            ...
            <div className={styles.loginModal__formGroup}>
              <label htmlFor="password" className={styles.loginModal__label}>
                Password
              </label>
        ...
        <div className={styles.loginModal__signupWrapper}>
          <p className={styles.loginModal__signupText}>
            ...
            <Link href="/get-started" className={styles.loginModal__signupLink}>
              Sign up
            </Link>
          </p>
        </div>
