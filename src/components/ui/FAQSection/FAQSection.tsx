        ...
        <div className={styles.faq__content}>
          <div className={styles.faq__heading}>
            <h2 className={styles.faq__title}>
              <span className={styles["faq__title-line"]}>Questions? </span>
              <br />
              <span className={styles["faq__title-line"]}>Here are </span>
              <br />
              <span className={styles["faq__title-line"]}>some </span>
              <br />
